...
public interface IMedicalRecordRepository
{
    ...
    public Task<MedicalRecord?> GetByIdWithDetailsAsync(Guid id);
    ...
    public Task<List<MedicalRecord>> GetByPatientIdAsync(Guid patientId);
    ...
    public Task<List<MedicalRecord>> GetByDoctorIdAsync(Guid doctorId);
    ...
    public Task<List<MedicalRecord>> GetByAppointmentIdAsync(Guid appointmentId);
    ...
    public Task<IEnumerable<MedicalRecord>> SearchAsync(
        Guid? patientId = null,
        Guid? doctorId = null,
    ...
    public Task<List<MedicalRecord>> GetByDateRangeAsync(DateTime fromDate, DateTime toDate);
    ...
    public Task<List<MedicalRecord>> GetByDiagnosisCodeAsync(string diagnosisCode);
